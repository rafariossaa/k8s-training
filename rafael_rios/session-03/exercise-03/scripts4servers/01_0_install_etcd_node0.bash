...
ExecStart=${ETCD_BIN_DIR}/etcd \\
  ...
  --client-cert-auth \\
  --advertise-client-urls https://${CONTROLLER0_PRIVATE_IP}:2379,https://127.0.0.1:2379 \\
  --listen-client-urls https://${CONTROLLER0_PRIVATE_IP}:2379,https://127.0.0.1:2379 \\
  --initial-cluster etcd0=http://${CONTROLLER0_PRIVATE_IP}:2380,etcd1=http://${CONTROLLER1_PRIVATE_IP}:2380 \\
  --initial-advertise-peer-urls http://${CONTROLLER0_PRIVATE_IP}:2380 \\
  --listen-peer-urls http://${CONTROLLER0_PRIVATE_IP}:2380 \\
