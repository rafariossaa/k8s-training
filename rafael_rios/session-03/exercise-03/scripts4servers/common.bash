...
# User SSH CERTS
#
export USER_SSH_CERT_DIR=~/kubernetes/Bitnami-Curso/cert
export USER_SSH_CERT=$USER_SSH_CERT_DIR/rafael_rios.pem
...
export CONTROLLER0_PUBLIC_IP=18.207.190.172
export CONTROLLER0_PRIVATE_IP=172.31.57.94

export CONTROLLER1_PUBLIC_IP=18.206.230.86
export CONTROLLER1_PRIVATE_IP=172.31.55.49

export WORKER0_PUBLIC_IP=35.171.153.231
export WORKER0_PRIVATE_IP=172.31.52.53

export WORKER1_PUBLIC_IP=54.234.135.179
export WORKER1_PRIVATE_IP=172.31.49.161

export KUBE_APISERVER_SERVICE_IP=10.200.0.1
export KUBE_DNS_SERVICE_IP=10.200.0.33

export CLUSTER_DOMAIN=rafacluster.local
