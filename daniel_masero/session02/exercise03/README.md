...
Added a dependency with postgresql and allows user selection, password and database name

Before you do the installation run this command:

	helm dependency update ./exercise03
